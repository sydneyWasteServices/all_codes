...
def clean_df(PATH):
    ...
    df['1st Weigh'] = pd.to_datetime(df["1st Weigh"], format="%d/%m/%Y %H:%M")
    df['2nd Weigh'] = pd.to_datetime(df["2nd Weigh"], format="%d/%m/%Y %H:%M")
...
PATH = "C:\\Users\\User\\Desktop\\blob_storage\\suez_tipping\\staged\\Suez_All.csv"
